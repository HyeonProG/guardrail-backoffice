      ...
      <div className="relative flex h-full items-center justify-center">
        ...
        >
          ...
          <div className="flex items-start justify-between border-b border-slate-200 px-7 py-6">
            ...
            <button
              className="inline-flex h-11 min-w-[88px] shrink-0 items-center justify-center whitespace-nowrap rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-600 transition hover:border-slate-300 hover:bg-slate-50"
              type="button"
              onClick={onClose}
            >
              닫기
