...
public class ProductDescriptionPromptFactory {
  ...
  public String createPrompt(ProductDescriptionGenerateCommand command) {
    return """
        ...
        - 확인된 상품 정보 안에서만 자연스럽고 간결하게 설명하세요.
        - 문장은 2문장 또는 3문장으로 작성하세요.
        - 첫 문장은 상품의 용도와 핵심 특징을 설명하세요.
        - 다음 문장은 색상, 형태, 착용감 또는 사용 장면을 자연스럽게 설명하세요.
        - 제목, 소제목, 불릿 포인트 없이 본문만 출력하세요.
        - 출력 예시 형식:
          검정색 운동화로 일상과 가벼운 야외 활동에 편하게 신기 좋은 상품입니다. 깔끔한 색감과 안정적인 착용감을 중심으로 부담 없이 활용할 수 있습니다.
        """
        .formatted(
