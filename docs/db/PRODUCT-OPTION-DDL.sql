...
create index idx_product_options_category_id on product_options (category_id);
...
create unique index uk_product_options_category_id_name_not_deleted
    on product_options (category_id, name)
    where deleted = false;
create unique index uk_product_options_category_id_sort_order_not_deleted
    on product_options (category_id, sort_order)
    where deleted = false;
